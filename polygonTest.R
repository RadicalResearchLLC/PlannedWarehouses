...
crs <- st_crs(4326)
pol1 <- st_sf(name = 'Bloomington Business Park', geom = st_sfc(st_polygon(list(b1))), crs = crs)
pol2 <- st_sf(name = 'Bloomington Business Park', geom = st_sfc(st_polygon(list(b2))), crs = crs)
pol3 <- st_sf(name = 'Bloomington Business Park', geom = st_sfc(st_polygon(list(b3))), crs = crs)
pol4 <- st_sf(name = 'Bloomington Business Park', geom = st_sfc(st_polygon(list(b4))), crs = crs)
...
WCUP1 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(WCUP_MW1))), crs = crs)
WCUP2 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(WCUP_MW2))), crs = crs)
WCUP3 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(WCUP_MW3))), crs = crs)
WCUP4 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW1))), crs = crs)
WCUP5 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW2))), crs = crs)
WCUP6 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW3))), crs = crs)
WCUP7 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW4))), crs = crs)
WCUP8 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW5))), crs = crs)
WCUP9 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW6))), crs = crs)
WCUP10 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_RW7))), crs = crs)
WCUPmu1 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_MU1))), crs = crs)
WCUPmu2 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_MU2))), crs = crs)
WCUPmu3 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_MU3))), crs = crs)
WCUPmu4 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_MU4))), crs = crs)
WCUPmu5 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_MU5))), crs = crs)
WCUPmu6 <- st_sf(name = 'West Campus Upper Plateau', geom = st_sfc(st_polygon(list(wcup_MU6))), crs = crs)
